...
openai.api_key = AIPROXY_TOKEN  # Use the token as the API key
openai.api_base = AIPROXY_BASE_URL  # Override the base URL to use the proxy
...
#             messages=[
#                 {"role": "system", "content": "You are an IITM assignment assistant."},
